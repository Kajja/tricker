 ...
 *
 * @param the game to which the objects shall be added
 */
 ...
 * the target ring.
 *
 * @return the index of the target ring
 */
...
/**
 * Calculate point after a round has been completed.
 *
 * @param the game where a round has ended
 */
utils.calcRoundPoints = function(game) {
     ...
     * @return true if the player is inside any of the rings else false
     */
 ...
 *
 * @param the game where the information shall be updated
 */
 ...
 *
 * @param the game where a winner might exist
 */
