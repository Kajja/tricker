...
function Tricker() {
    ...
    // Reference to the process that handles, count down etc. in a round
    this.roundProcessId;
};
 ...
 * @param {Object} game - the game that is associated with the event
 * @param {Object} socket - the socket where the event was received
 *
...
Tricker.prototype.eventHandler = function(event, game, socket) {
    ...
    switch(type) {
        ...
        case 'new_round':
            ...
            this.roundProcessId = game.timer(knower, guesser);
        ...
        case 'disconnect':
            ...
            if (game.getPlayers().length < this.minPlayers) {
                ...
                // Stop the round process
                clearInterval(this.roundProcessId);
            }
            break;
    }
};
 ...
 *
 * @return {String} type - a description of the type of rules object this is
 */
